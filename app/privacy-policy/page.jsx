const PrivacyPolicy = () => {
  return (
    <section className='mt-24 max-w-2xl m-auto p-6'>
      <h1 className='text-4xl text-center my-6'>Aviso de Privacidad</h1>
      <p>De acuerdo a lo Previsto en la “Ley Federal de Protección de Datos Personales”, declara <strong>GOVEL SA DE CV y/o Francisco Gómez Velázquez  (Representante Legal)</strong>, ser una empresa moral legalmente constituida de conformidad con las leyes mexicanas, con domicilio fiscal en <strong>Mayas #760 en Tepatitlán de Morelos, Jalisco</strong>, y como responsable del tratamiento de sus datos personales, hace de su conocimiento que la información de nuestros clientes es tratada de forma estrictamente confidencial por lo que al proporcionar sus datos personales, <strong>tales como:</strong></p>
      <ul className='list-decimal  font-bold p-6'>
        <li>Nombre y/o Razón social</li>
        <li>Teléfonos de Oficina y móviles</li>
        <li>Correo Electrónico</li>
      </ul>
      <p className=''>Estos serán utilizados única y exclusivamente para los siguientes fines:</p>
      <ul className='list-decimal font-bold p-6'>
